      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {watermark && <HeraldicWatermark size={watermarkSize} opacity={watermarkOpacity} />}
...
export function DialogTitle({ className, ...props }: HTMLAttributes<HTMLHeadingElement>) {
  ...
  return (
    <h2
      id={`${dialogId}-title`}
      className={cn("font-display text-xl font-semibold tracking-tight text-ink pr-10", className)}
      {...props}
    />
  );
}
